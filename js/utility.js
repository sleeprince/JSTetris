...
const wordsById = {
    ...
    */
    ...
    expandToRight: {
        english: {
            innerHTML: `Touch buttons will appear`,
            style: {
                fontFamily: ``,
                fontSize: '',
                fontWeight: '',
        ...
        /* 흔히 돌쩌귀를 달아 여닫는 문으로 마루와 방 사이의 문이나 부엌의 바깥문을 일컬어 “지게(戶)”라고 한다.
        아울러 옛 집에서 창문을 일컬어 ‘지게차ᇰ’, ‘차ᇰ지게’, ‘지게’라고 했다. 
        《본문온역이해방》(1541년) 中
            【져ᇰ월 초ᄒᆞᄅᆞᆺ날 아ᄎᆞᄆᆡ 도ᇰ녁으로 버든 ᄲᅩᇰ나못 불휘 손ᄭᅡ락 ᄀᆞᄐᆞ니 기ᄅᆡ 닐굽 치ᄅᆞᆯ 다가 쥬사로 ᄇᆞᆯ라 문과 지게 우희 ᄆᆡ야 ᄃᆞᆯ라
            (정월 초하룻날 아침에 동녁으로 뻗은 뽕나부의 뿌리가 손가락 같은 것, 길이 일곱 치를 가져다가 주사로 발라 문과 창문 위에 매달라.)】
        한편 옛 집의 대문을 일컬어서는 “오래”라고 하였다.
        오늘날의 《표준국어대사전》에도 “오래뜰”이라고 하여 대문 또는 중문 안에 있는 뜰을 가리키는 낱말이 올라 있다.
        《여씨향약언해》(1518년 김안국易) 中
    ...
    expandToLeft: {
        ...
        /* 
        1. “다티다(← 닿‐ + ‐티‐)” 는 “몸이나 물건을 건드리다”라는 뜻의 “다치다”의 옛말이다.
        《월인석보》(1459년 세종作 세조編) 中
            【바ᄅᆞᆳ 믌겨리 頗팡梨롕山산ᄋᆞᆯ 다티ᄃᆞᆺ ᄒᆞ니라
            (바다의 물결이 파리산을 부딪치듯 한 것이다.)】
        《능엄경언해》(1462년 간경도감刊) 中
            【ᄒᆞ다가 ᄀᆞᄃᆞᆨ디 아니호ᇙ딘댄 네 머리 다티ᇙ 제 當다ᇰᄒᆞ야 ᄯᅩ 바ᄅᆞᆯ 다텨ᄃᆞᆫ 머리ᄂᆞᆫ 아로미 잇고 바ᄅᆞᆫ 반ᄃᆞ기 아로미 업스리어늘
            (만일 가득하지 아니할 것 같으면, 네 머리를 건드릴 적에 당하여 또 발을 건드리거든 머리는 앎이 있고 발은 마땅히 앎이 없을 것이거늘)】
        2. 단추를 일컬어 “ᄃᆞᆯ마기”라고 했다.
        “단추”의 옛말 “단쵸”는 17세기 문헌에서부터 나타난다. 
        《번역노걸대》(1517년 최세환 易) 中
            【ᄯᅩ 비단으로 드르 두 녁 가르 ᄠᅡ ᄃᆞᆯ마기 ᄃᆞ론 갇애 야ᇰ지옥 디ᇰᄌᆞ 브텨시니
            (또 비단으로 둘레를 둘로 갈라내어 단추를 단 갓에 양지옥(羊脂玉) 증자[頂子]를 부쳤으니.)】
        3. “나타나다”는 동사 “낟다/낱다”와 “나다”의 통사적 합성어로(낟/낱‐ + ‐아 + 나‐)
        “낟다/낱다”는 “나타나다(現)”라는 뜻이다. 15세기 두 형태로 모두 쓰였다.
        《능엄경언해》(1462년 간경도감刊) 中
